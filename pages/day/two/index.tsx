...
const part1_text = `document
  .getElementsByTagName("Pre")[0]
  .innerText.trim()
  .split("\\n")
  .reduce((validPasswords, line) => {
...
const two = () => {
  ...
  return (
    <>
      <Header pageTitle="Day 2: Password Philosophy"></Header>
        ...
        <main className={styles.main}>
          ...
          <div>
            <div style={{ textAlign: "center" }}>
              ...
              <br />
              Paste solution into console, press enter.
            </div>
