      ...
      <div className={styles.container}>
        <main className={styles.main}>
          <p className={styles.description}>
            ...
            <Link href="/puzzle-input/d8p1.html">
              <button>Input.html</button>
            </Link>
          </p>
          <div>
            <div style={{ textAlign: "center" }}></div>
            <p style={{ textAlign: "center" }}>Check if infinite</p>
            <div className={styles.code}>
              <pre>{d8_checkIfInf_text}</pre>
            </div>
            ...
            <p style={{ textAlign: "center" }}>
              Whenever encountering "jmp" or "nop" start an alternate
              instruction
            </p>
            <div className={styles.code}>
              <pre>{d8p2_text}</pre>
